...
public class Player {
	...
	public static void main(final String args[]) {
		...
		while (true) {
			...
			final String effectiveCommand = playground.compute();
			System.err.println(playground.toUnitTestString(effectiveCommand));
			System.out.println(effectiveCommand); // Your destination coordinates
		}
	}
}