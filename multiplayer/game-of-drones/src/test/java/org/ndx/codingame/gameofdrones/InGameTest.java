...
public class InGameTest {
	...
	@Test public void can_find_moves_1491420023187() {
		...
		final List<Drone> d=new ArrayList<>();
			...
			d.add(new Drone(2729.0, 858.0, 2824.0, 827.0, 1, 0));
			d.add(new Drone(2741.0, 787.0, 2644.0, 810.0, 1, 1));
			d.add(new Drone(467.0, 600.0, 457.0, 510.0, 1, 2));
			d.add(new Drone(1117.0, 743.0, 1211.0, 776.0, 1, 3));
			d.add(new Drone(2729.0, 858.0, 2824.0, 827.0, 1, 4));
			d.add(new Drone(2741.0, 787.0, 2644.0, 810.0, 1, 5));
			d.add(new Drone(467.0, 600.0, 457.0, 510.0, 1, 6));
			d.add(new Drone(1117.0, 743.0, 1211.0, 776.0, 1, 7));
			d.add(new Drone(2729.0, 858.0, 2824.0, 827.0, 1, 8));
