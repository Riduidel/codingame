...
public class EvolvableConstants {
	...
	public static final int INTERNAL_SCORE_FOR_SMALL_PILL = 1*100;
	public static final int INTERNAL_SCORE_FOR_POTENTIAL_SMALL_PILL = 1*100;
	public static final int INTERNAL_SCORE_FOR_BIG_PILL = 10*100;
	public static final Integer INTERNAL_SCORE_FOR_BIG_PILL_DISTANCE = 1;
