...
public class EvolvableConstants {
	...
	public static final int HORIZON_FOR_RECURSIVE_PATH = 15;
	...
	public static final int INTERNAL_SCORE_FOR_POTENTIAL_SMALL_PILL = 80;
//	public static final long DELAY_FOR_PREDICTION = 1000*60*60;
	...
	public static final int INTERNAL_SCORE_FOR_ENEMY_PREY = 70;
	public static final int INTERNAL_SCORE_FOR_PAC_TRACE = 10;
	public static final double DISTANCE_ENEMY_TOO_CLOSE = 20;
}