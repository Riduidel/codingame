...
public class Playground {
	...
	public static String toUnitTestString(final Status status, final List<Entity> playing, final List<Wizard> myTeam) {
		...
		returned.append(CONTENT_PREFIX).append(ToUnitTestHelpers.writeVariableAssignment(playing, List.class, Entity.class, ArrayList.class, "playing")).append("\n");
		...
		returned.append(CONTENT_PREFIX).append(ToUnitTestHelpers.writeVariableAssignment(myTeam, List.class, Wizard.class, ArrayList.class, "myTeam")).append("\n");
